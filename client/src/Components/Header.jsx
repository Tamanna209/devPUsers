...
const Header = () => {
  return (
    <div className='flex align-middle h-14 bg-blue-950 text-white justify-between'>
      ...
      <div className='flex w-42 justify-around align-middle mt-2'>
        <Link to='/myPosts' className='mt-1 font-semibold hover:text-amber-800'>My Posts</Link>
